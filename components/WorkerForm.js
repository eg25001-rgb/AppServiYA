...
const workerSchema = z.object({
  ...
  dateOfBirth: z.string().min(10, 'Formato YYYY-MM-DD.'),
  dui: z.string().min(9, 'DUI inválido.'),
  department: z.string().min(3, 'Departamento requerido.'),
  municipality: z.string().min(3, 'Municipio requerido.'),
  address: z.string().min(5, 'Dirección requerida.'),
  biography: z.string().min(10, 'Biografía muy corta.'),
  yearsOfExperience: z.coerce.number().min(0, 'Años de experiencia requerido.'),
  hourlyRate: z.coerce.number().min(0, 'Tarifa por hora requerida.'),
  termsAndConditions: z.literal(true, {
    errorMap: () => ({ message: 'Debes aceptar los términos para proveedores.' }),
  }),
});
    ...
    <View style={styles.modalOverlay}>
      <View style={styles.modalContent}>
        ...
        <Text style={styles.modalMessage}>
          Bienvenido {userName}.{'\n'}
          Tu cuenta de proveedor ha sido creada correctamente.
        </Text>
...
export default function WorkerForm({ navigation }) {
  ...
  const onSubmit = async (data) => {
    console.log('🟢 ========== INICIO DE REGISTRO PROVEEDOR ==========');
    ...
    try {
      ...
      await setDoc(doc(firestore, 'users', user.uid), workerData);
      ...
      switch (error.code) {
        ...
        case 'permission-denied':
          errorMessage = 'No tienes permisos. Verifica la configuración de Firebase.';
          break;
        default:
  ...
  return (
    <View style={styles.container}>
      ...
      <FormCheckbox 
        ...
        label="Acepto los términos para proveedores" 
